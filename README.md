# flutter_bar_scanner_alternative
...
### Continuous scan
* If you need to scan barcodes continuously without closing camera use `FlutterBarScannerAlternative.getBarcodeStreamReceiver`
